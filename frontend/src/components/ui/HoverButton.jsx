  ...
  return (
    <button
      ...
      className={cn(
        ...
        'backdrop-blur-lg bg-white/10 dark:bg-white/10',
        'cursor-pointer overflow-hidden',
        "before:content-[''] before:absolute before:inset-0",
        'before:rounded-[inherit] before:pointer-events-none',
        'before:z-[1]',
        'before:shadow-[inset_0_0_0_1px_rgba(191,148,255,0.3),inset_0_0_16px_0_rgba(191,148,255,0.15),inset_0_-3px_12px_0_rgba(191,148,255,0.2),0_1px_3px_0_rgba(0,0,0,0.30),0_4px_12px_0_rgba(0,0,0,0.25)]',
      ...
      style={{
        '--circle-start': 'var(--tw-gradient-from, #bf94ff)',
        '--circle-end': 'var(--tw-gradient-to, #7A47A6)',
      }}
      {...props}
    >
